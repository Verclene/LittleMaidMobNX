...
public class LMM_EntityAIHurtByTarget extends EntityAIHurtByTarget {
	...
	protected boolean isSuitableTarget(EntityLivingBase par1EntityLiving, boolean par2) {
		...
		if (!taskOwner.func_180485_d(new BlockPos(MathHelper.floor_double(par1EntityLiving.posX), MathHelper.floor_double(par1EntityLiving.posY), MathHelper.floor_double(par1EntityLiving.posZ)))) {
			return false;
		}
